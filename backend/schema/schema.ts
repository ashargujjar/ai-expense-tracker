...
export const expensesZodSchema = z.object({
  ...
  items: z.array(
    z.object({
      ...
      category: z
        ...
        .max(10, "category must be at most 10 characters"),
      quantity: z
        .number()
      ...
      total: z
        .number()
        .min(1, "quantity must be at least 1 ")
        .max(10, "total must be at most 10 "),
    }),
  ),
  ...
  totalItems: z
    ...
    .max(10, "totalAmount must be at most 10 "),
  totalAmount: z
    .number()
    .min(1, "totalAmount must be at least 1 character")
    .max(10, "totalAmount must be at most 10 characters"),
});
